<?php	
	...
	$random = rand();
	$archivo = 'reporte30a60dias'.$random;
	...
	$totalArchivos = "1";
		...
		foreach($resultadoConsulta as $row){
			...
			if($crearArchivo == $limiteRegistros){ 
				...
				echo'<a  lt="Descargar Reporte csv" style="text-decoration: none;color: #2196f3" href="./'.$archivo.$totalArchivos.'.csv" download><img src="download-icon.png"  height="16" width="16"> Descargar archivo 30 a 60 días</a></div>';
